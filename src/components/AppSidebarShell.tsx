...
const NAV_ITEMS: NavItemDef[] = [
  { href: '/app', icon: <LayoutDashboard className="h-4 w-4" />, label: 'Dispatch overview' },
  { href: '/app/incidents', icon: <Activity className="h-4 w-4" />, label: 'Incident queue' },
  { href: '/app/tasks', icon: <ClipboardList className="h-4 w-4" />, label: 'Tasks' },
  { href: '/app/map', icon: <Map className="h-4 w-4" />, label: 'Operations map' },
  { href: '/app/workers', icon: <Users className="h-4 w-4" />, label: 'Workers' },
  { href: '/app/notifications', icon: <Bell className="h-4 w-4" />, label: 'Notifications' },
        ...
        >
          {!collapsed && (
            <>
              ...
              <span className="flex-1 font-semibold text-sm truncate">Sentinel ONE</span>
            </>
          )}
          <Tooltip>
          ...
          {collapsed ? (
              ...
              <TooltipTrigger asChild>
                <button className="flex items-center justify-center h-8 w-8 rounded-md hover:bg-accent transition-colors cursor-pointer">
                  <Avatar className="h-6 w-6 shrink-0">
                    ...
                    <TooltipContent side="right">Sentinel operator</TooltipContent>
            </Tooltip>
          ) : (
            <button className="flex items-center gap-2 rounded-md hover:bg-accent transition-colors cursor-pointer w-full px-2 py-1.5">
              ...
              <div className="flex-1 min-w-0 text-left">
                <p className="text-xs font-medium leading-tight truncate">Operator</p>
